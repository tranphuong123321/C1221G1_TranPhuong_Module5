...
export class FacilityFormComponent implements OnInit {
  public facilityForm = new FormGroup({
    ...
    cost: new FormControl('', [Validators.required, Validators.pattern('[+]?\\\\d*\\\\.?\\\\d*')]),
    maxPeople: new FormControl('', [Validators.required, Validators.pattern('[+]?\\\\d*\\\\.?\\\\d*')]),
    rentType: new FormControl('', [Validators.required]),
    romStandard: new FormControl('', [Validators.required]),
    otherAamenities: new FormControl('', [Validators.required]),
    poolArea: new FormControl('', [Validators.required, Validators.pattern('[+]?\\\\d*\\\\.?\\\\d*')]),
